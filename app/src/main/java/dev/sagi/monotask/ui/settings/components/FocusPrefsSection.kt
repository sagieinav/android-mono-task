...
import dev.sagi.monotask.designsystem.components.MonoSwitch
import dev.sagi.monotask.designsystem.components.MonoSlider
    ...
    SettingsSection("Focus Preferences") {
        ...
        SettingsRow(
            ...
            leadingIcon = {
                SettingsRowIcon(
                    IconPack.Cognition,
                    color = SettingsIconColors.hyperfocus
                )
            },
            trailingContent = {
                MonoSwitch(
        ...
        SettingsRow(
            ...
            leadingIcon = {
                SettingsRowIcon(
                    IconPack.LowPriority,
                    color = SettingsIconColors.priority
                )
            },
